...
require(pacman)
pacman::p_load(terra, gtools, ggnewscale, hrbrthemes, kableExtra, stringr, sf, tidyverse, fs, colorspace, foreign, cowplot, ggspatial, kableExtra, readxl, rnaturalearthdata, rnaturalearth)
library(httr)    
