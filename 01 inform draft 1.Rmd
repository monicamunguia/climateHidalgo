...
```{r mainMap, warning = FALSE, echo = FALSE, fig.align = 'center',  fig.cap = "Ubicación geográfica de Tula de Allende dentro del Estado de Hidalgo", fig.pos = "top"}
...
g.hdlg <- autoplot(map.latlon, alpha = 0.5) + 
  geom_sf(data = st_as_sf(hdlg), fill = NA, col = 'grey20', inherit.aes = FALSE) +
  geom_sf(data = st_as_sf(tula), aes(fill = NAME_2), col = 'darkred', alpha = 0.2, inherit.aes = FALSE) + 
  geom_sf(data = mex1, fill = NA, col = 'grey70', inherit.aes = FALSE) +
